...
class Filter_functionality_tester:
    ...
    def take_input(self):
        ...
        for i in range(input_size):
            ...
            self.__search_strings.append(search_string_input)
            
        self.__key = input('Enter Key: ')
    ...
    def invoke_string_evaluator(self):
        ...
        print('Checking from Start:', string_evaluator_obj.
                                    filter_(self.__search_strings, self.__key, criterion_obj.check_from_start))
        print('Checking from End:', string_evaluator_obj.
                                    filter_(self.__search_strings, self.__key, criterion_obj.check_from_end))
        print('Checking for Exact Match:', string_evaluator_obj.
                                    filter_(self.__search_strings, self.__key, criterion_obj.check_equal))
